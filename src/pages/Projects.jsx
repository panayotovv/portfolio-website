...
const projects = [
  ...
  },
  {
    ...
    tag: "Frontend",
    live: true,
    desc: "Developer portfolio built in React with scroll-triggered animations, a procedural 3D star field via Three.js, and fluid UI transitions across all sections. Problem solved: a living, interactive resume that stands out beyond a plain PDF.",
    tech: ["React", "Three.js"],
